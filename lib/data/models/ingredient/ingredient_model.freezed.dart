...
mixin _$IngredientModel {
  int? get id => throw _privateConstructorUsedError; // ID generado por la DB
  String get name =>
      throw _privateConstructorUsedError; // Nombre del ingrediente
...
abstract class $IngredientModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String name, String userId});
}
...
class _$IngredientModelImpl implements _IngredientModel {
  _$IngredientModelImpl({this.id, required this.name, required this.userId});
...
// Nombre del ingrediente
  ...
  @override
  String toString() {
    return 'IngredientModel(id: $id, name: $name, userId: $userId)';
  }
...
abstract class _IngredientModel implements IngredientModel {
  factory _IngredientModel(
      ...
      required final String userId}) = _$IngredientModelImpl;

  factory _IngredientModel.fromJson(Map<String, dynamic> json) =
      _$IngredientModelImpl.fromJson;

  @override
  int? get id; // ID generado por la DB
  @override
  String get name; // Nombre del ingrediente
  @override
  String get userId;
